    ...
    <main className="px-6 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <header className="mt-6">
          <p className="text-sm text-slate-500">{COPY.createAssessment.eyebrow}</p>

          <h1 className="mt-1 text-3xl font-bold tracking-tight">
            {COPY.createAssessment.title}
          </h1>

          <p className="mt-2 text-slate-600">{COPY.createAssessment.description}</p>
        </header>
        ...
        >
          <div>
            ...
            <input
              ...
              placeholder={COPY.createAssessment.fields.namePlaceholder}
              required
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={COPY.createAssessment.fields.descriptionPlaceholder}
              required
              rows={4}
              className="w-full rounded-md border px-3 py-2 text-sm outline-none focus:ring-2"
            />
